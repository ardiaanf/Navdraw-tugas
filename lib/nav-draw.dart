...
Widget _drawerHeader() {
  return UserAccountsDrawerHeader(
    ...
    otherAccountsPictures: [
      ClipOval(
        child: Image(image: NetworkImage('https://cdn.pixabay.com/photo/2021/01/22/18/09/windy-5940755__340.png'), fit: BoxFit.cover),
      ),
      ClipOval(
        child: Image(image: NetworkImage('https://media.istockphoto.com/photos/kitten-looking-up-picture-id1281700863?b=1&k=20&m=1281700863&s=170667a&w=0&h=-ikJUy0bE3hxaVARLuiE3bo4ovced0XJUL3UtVVHXA0='), fit: BoxFit.cover),
      )
    ],
    accountName: Text('Ardian F'),
